<?php
	...
	if(isset($_POST["report_buyer"])){
		$myObj = new stdClass();
		
		// Get User ID of the accused
		$accused_ID = -1;
		...
		$sql = "INSERT INTO complaints (company_id,user_id,message,date_created,is_sent_by_buyer,image_location,complaint_type)
					VALUES ('".$_POST["company_id"]."','".$accused_ID."','".$_POST["comment"]."','".date("Y-m-d")."','0','','".$_POST["violation"]."')";
